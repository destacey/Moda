...
const menuItems: (Item | MenuItem)[] = [
  ...
  menuItem('PPM', 'ppm', null, menuIcons.ppm, [
    ...
    // restrictedPermissionMenuItem('Permissions.Programs.View', 'Programs', 'ppm.programs'),
    // restrictedPermissionMenuItem('Permissions.Projects.View', 'Projects', 'ppm.projects'),
  ]),
