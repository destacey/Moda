    ...
    "SecuritySettings": {
        "Providers": {
            "Entra": {
                ...
                "Audience": "api://{your API client ID}/access_as_user",
...
| `Audience` | yes | Token `aud` claim must match. Same scope the frontend uses. |
...
dotnet user-secrets set "SecuritySettings:Providers:Entra:Audience" "api://{your API client ID}/access_as_user"
