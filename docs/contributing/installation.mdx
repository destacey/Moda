---
title: Installation
description: How to clone, build, and run Moda locally.
sidebar_position: 5
audience: [developer]
---
...
Moda uses SQL Server. You can use SQL Server LocalDB, a full SQL Server instance, or a Docker container.
