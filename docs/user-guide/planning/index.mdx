...
- **[Work Items](../work-management/index.mdx#work-items)** are assigned to Sprints for execution. Sprint assignment is visible on the [work item detail page](../work-management/index.mdx#work-item-detail-page).
...
5. **[Work Items](../work-management/index.mdx#work-items)** live in sprints and represent the actual work being done
