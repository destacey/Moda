...
**Teams Tab:**
- Grid of all [teams](../organizations/index.mdx#teams) assigned to the PI

**Sprint Mappings Tab:**
- Configuration grid mapping each team's [sprints](./sprints.mdx) to PI iterations
...
**Backlog Tab:**
- Combined sprint backlog grid showing [work items](../work-management/index.mdx#work-items) from all mapped sprints
...
Objectives bridge the gap between strategic intent and execution. A team commits to objectives during PI planning, then links [work items](../work-management/index.mdx#work-items) that fulfill those objectives. As work items are completed in [sprints](./sprints.mdx), objective progress is tracked.
...
- **Work Items Card** — Grid of linked [work items](../work-management/index.mdx#work-items) with ability to link/unlink
