...
- **[Projects](../project-portfolios/projects.mdx)** can be associated with portfolio-tier work items. Projects track work on their [Work Items tab](../project-portfolios/projects.mdx#project-detail-page).
...
| Managed read-only | [Work items](./work-items.mdx#work-items) in managed [workspaces](./work-items.mdx#workspaces) cannot be edited in Moda |
...
| Project inheritance | Child work items inherit [project](../project-portfolios/projects.mdx) assignment from parent |
