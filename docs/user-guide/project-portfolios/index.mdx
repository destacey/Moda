...
- **[Work Items](../work-management/index.mdx#work-items)** from [workspaces](../work-management/index.mdx#workspaces) can be associated with projects on the [Project Work Items tab](./projects.mdx#project-detail-page).
...
- **[Projects](./projects.mdx)** — Project lifecycle, phases, tasks, dependencies, and the plan tab
