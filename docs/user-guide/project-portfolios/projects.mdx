...
**Work Items Tab** — Grid of [work items](../work-management/index.mdx#work-items) from Work Management that are associated with this project.
...
> **Note:** These are project task dependencies within PPM. For work item dependencies across [workspaces](../work-management/index.mdx#workspaces), see [Work Item Dependencies](../work-management/index.mdx#work-item-dependencies).
