...
- **[Expenditure Category](../settings/index#expenditure-categories)** — Budget classification
- **[Lifecycle](#project-lifecycles)** — Defines the phases the project goes through
- **Roles** — Sponsor, Owner, Manager, Member
- **[Strategic Theme Tags](../strategic-management/index#strategic-themes)** — Links to strategic themes
...
- A project can belong to at most one [program](./portfolios-programs#programs) (or none)
...
*Left sidebar* — [Portfolio](./portfolios-programs#portfolios) link, [Program](./portfolios-programs#programs) link (if assigned), date range, [Expenditure Category](../settings/index#expenditure-categories), Lifecycle name with tooltip, [Strategic Themes](../strategic-management/index#strategic-themes), Sponsors/Owners/Managers/Members, timeline progress bar, and links.
...
**Team Tab** — Grid of all [team](../organizations/index#teams) members with their roles, showing the people assigned across all project roles.
...
**Work Items Tab** — Grid of [work items](../work-management/index#work-items) from Work Management that are associated with this project.

## Project Lifecycles

A **Project Lifecycle** defines the template of phases that a project goes through from inception to completion. Lifecycles are configured in [Settings > PPM > Project Lifecycles](../settings/index#project-lifecycles).
...
> **Note:** These are project task dependencies within PPM. For work item dependencies across [workspaces](../work-management/index#workspaces), see [Work Item Dependencies](../work-management/index#work-item-dependencies).

## Common Tasks

### Creating a Project

1. Navigate to a [portfolio's](./portfolios-programs#portfolios) detail page, or **PPM > Projects**
2. Click **Create Project**
3. Enter **Name**, **Key** (project code), and **Description**
4. Optionally set **Business Case**, **Expected Benefits**, and **[Expenditure Category](../settings/index#expenditure-categories)**
5. Assign a **[Lifecycle](#project-lifecycles)** to enable approval
6. Add **Roles** to assign [team](../organizations/index#teams) members
...
1. Navigate to [Settings > PPM > Project Lifecycles](../settings/index#project-lifecycles)
