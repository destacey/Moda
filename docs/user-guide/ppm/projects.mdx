...
The page header also shows a **Health flag** when the project has an active health check. Hovering the flag shows details (status, reported by, reported on, expiration, and note).
...
2. In **Page Actions**, click **Create Health Check**.
...
From the project detail page, open **Page Actions > Health Report**.
...
2. Use **Page Actions > Create Health Check** to record current health.
...
5. Review **Page Actions > Health Report** during project reviews to track trend changes.
