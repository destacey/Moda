...
{
    Task<Result<IExternalWorkspace>> GetProject(string organizationUrl, string token, Guid projectId);
    Task<Result<List<IExternalWorkspace>>> GetProjects(string organizationUrl, string token);
