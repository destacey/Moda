...
namespace Wayd.Infrastructure.Migrators.MSSQL.Migrations
{
    ...
    [Migration("20240609144717_Add-DoneTimestamp-to-WorkItem")]
    partial class AddDoneTimestamptoWorkItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wayd.Goals.Domain.Models.Objective", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("IsDeleted"), new[] { "Id", "Key", "Name", "Type", "Status", "OwnerId", "PlanId", "Order" });
            ...
            modelBuilder.Entity("Wayd.Planning.Domain.Models.PlanningIntervalIteration", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("IsDeleted"), new[] { "Id", "Key", "PlanningIntervalId", "Name", "Type" });
            ...
            modelBuilder.Entity("Wayd.Work.Domain.Models.WorkItem", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ExternalId"), new[] { "Id", "Key", "Title", "WorkspaceId", "AssignedToId", "TypeId", "StatusId", "StatusCategory", "DoneTimestamp" });

                    b.HasIndex("Id");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Id"), new[] { "Key", "Title", "WorkspaceId", "ExternalId", "AssignedToId", "TypeId", "StatusId", "StatusCategory", "DoneTimestamp" });

                    b.HasIndex("Key");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Key"), new[] { "Id", "Title", "WorkspaceId", "ExternalId", "AssignedToId", "TypeId", "StatusId", "StatusCategory", "DoneTimestamp" });
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("StatusCategory"), new[] { "Id", "Key", "Title", "WorkspaceId", "AssignedToId", "TypeId", "StatusId", "DoneTimestamp" });
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Key", "Title"), new[] { "Id", "WorkspaceId", "ExternalId", "AssignedToId", "TypeId", "StatusId", "StatusCategory", "DoneTimestamp" });
                            ...
                            b1.OwnsMany("Wayd.AppIntegration.Domain.Models.AzureDevOpsBoardsWorkspace", "Workspaces", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("Wayd.AppIntegration.Domain.Models.AzureDevOpsBoardsWorkspace.IntegrationState#IntegrationState", "IntegrationState", b3 =>
                                        {
