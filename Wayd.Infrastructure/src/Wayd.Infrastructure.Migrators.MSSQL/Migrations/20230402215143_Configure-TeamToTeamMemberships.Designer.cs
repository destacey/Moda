...
namespace Wayd.Infrastructure.Migrators.MSSQL.Migrations
{
    ...
    [Migration("20230402215143_Configure-TeamToTeamMemberships")]
    partial class ConfigureTeamToTeamMemberships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wayd.Organization.Domain.Models.TeamToTeamMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TeamToTeamMemberships", "Organization");
                });
            ...
            modelBuilder.Entity("Wayd.Organization.Domain.Models.TeamToTeamMembership", b =>
                {
                    ...
                    b.OwnsOne("Wayd.Organization.Domain.Models.MembershipDateRange", "DateRange", b1 =>
                        {
                            b1.Property<Guid>("TeamToTeamMembershipId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("TeamToTeamMembershipId");

                            b1.HasIndex("Start", "End");

                            b1.ToTable("TeamToTeamMemberships", "Organization");

                            b1.WithOwner()
                                .HasForeignKey("TeamToTeamMembershipId");
                        });
