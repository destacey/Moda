...
namespace Wayd.Infrastructure.Migrators.MSSQL.Migrations
{
    ...
    [Migration("20240203224920_Update-integration-related-schemas")]
    partial class Updateintegrationrelatedschemas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wayd.Planning.Domain.Models.PlanningIntervalIteration", b =>
                {
                    ...
                    b.OwnsOne("Wayd.Common.Models.LocalDateRange", "DateRange", b1 =>
                        {
                            b1.Property<Guid>("PlanningIntervalIterationId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("PlanningIntervalIterationId");

                            b1.HasIndex("Start", "End");

                            b1.ToTable("PlanningIntervalIterations", "Planning");
            ...
            modelBuilder.Entity("Wayd.Work.Domain.Models.WorkflowScheme", b =>
                {
                    ...
                    b.HasOne("Wayd.Work.Domain.Models.Workflow", null)
                        .WithMany("Schemes")
            ...
            modelBuilder.Entity("Wayd.Work.Domain.Models.Workspace", b =>
                {
                    b.HasOne("Wayd.Work.Domain.Models.WorkProcess", null)
                        .WithMany("Workspaces")
                        .HasForeignKey("WorkProcessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
