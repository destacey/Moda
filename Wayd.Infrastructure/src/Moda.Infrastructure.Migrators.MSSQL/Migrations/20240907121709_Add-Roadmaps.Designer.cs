...
namespace Wayd.Infrastructure.Migrators.MSSQL.Migrations
{
    ...
    [Migration("20240907121709_Add-Roadmaps")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wayd.Planning.Domain.Models.Roadmap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("DateRange", "Wayd.Planning.Domain.Models.Roadmap.DateRange#LocalDateRange", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Wayd.Planning.Domain.Models.RoadmapLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wayd.Planning.Domain.Models.RoadmapManager", b =>
                {
            ...
            modelBuilder.Entity("Wayd.Planning.Domain.Models.RoadmapLink", b =>
                {
                    b.HasOne("Wayd.Planning.Domain.Models.Roadmap", "Child")
                        .WithMany()
                        .HasForeignKey("ChildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wayd.Planning.Domain.Models.Roadmap", "Parent")
                        .WithMany("ChildLinks")
            ...
            modelBuilder.Entity("Wayd.Planning.Domain.Models.RoadmapManager", b =>
                {
                    ...
                    b.HasOne("Wayd.Planning.Domain.Models.Roadmap", null)
                        .WithMany("Managers")
                            ...
                            b1.OwnsMany("Wayd.AppIntegration.Domain.Models.AzureDevOpsBoardsWorkspaceTeam", "WorkspaceTeams", b2 =>
                                {
                                    ...
                                    b2.HasKey("AzureDevOpsBoardsTeamConfigurationAzureDevOpsBoardsConnectionId", "Id");
