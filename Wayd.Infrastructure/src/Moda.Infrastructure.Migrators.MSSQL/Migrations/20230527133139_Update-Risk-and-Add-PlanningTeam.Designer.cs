...
namespace Wayd.Infrastructure.Migrators.MSSQL.Migrations
{
    ...
    [Migration("20230527133139_Update-Risk-and-Add-PlanningTeam")]
    partial class UpdateRiskandAddPlanningTeam
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wayd.Common.Domain.Models.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wayd.Common.Domain.Models.Employee", b =>
                {
                    b.HasOne("Wayd.Common.Domain.Models.Employee", "Manager")
            ...
            modelBuilder.Entity("Wayd.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.HasOne("Wayd.Common.Domain.Models.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Wayd.Planning.Domain.Models.Risk", b =>
                {
                    b.HasOne("Wayd.Common.Domain.Models.Employee", "Assignee")
                        .WithMany()
                        .HasForeignKey("AssigneeId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Wayd.Common.Domain.Models.Employee", "ReportedBy")
                        .WithMany()
