...
namespace Wayd.Infrastructure.Migrators.MSSQL.Migrations
{
    ...
    [Migration("20250316155622_Add-StrategicInitiative")]
    partial class AddStrategicInitiative
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiative", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiativeKpi", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiativeKpiCheckpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiativeKpiMeasurement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiativeProject", b =>
                {
                    b.Property<Guid>("StrategicInitiativeId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wayd.ProjectPortfolioManagement.Domain.Models.RoleAssignment<Wayd.ProjectPortfolioManagement.Domain.Enums.StrategicInitiativeRole>", b =>
                {
                    ...
                    b.HasOne("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiative", null)
                        .WithMany("Roles")
                        .HasForeignKey("ObjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiativeKpiCheckpoint", b =>
                {
                    b.HasOne("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiativeKpi", null)
            ...
            modelBuilder.Entity("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiativeProject", b =>
                {
                    ...
                    b.HasOne("Wayd.ProjectPortfolioManagement.Domain.Models.StrategicInitiative", "StrategicInitiative")
                        .WithMany("StrategicInitiativeProjects")
                        .HasForeignKey("StrategicInitiativeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
